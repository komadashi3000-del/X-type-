...
<p>キーワード: 「浅い納得で終わらない」「問いを生きる形へ返す」</p>
  ...
  const aGroupDetailedOverrides = {
    "A-DOS": {
      title: "先導者（A-DOSA/E）",
      body: `
        <h3>先導者（A-DOSA/E）</h3>
        <p>先導者は、愛情を「方向性」に変える人です。大切な相手や場に対して、寄り添うだけでなく、よりよい進路を作ろうとします。</p>
        <p>本質は <strong>「深い誠実さ」×「方向を示す力」×「現実の中で前へ運ぶ力」</strong> にあります。</p>
        <h4>A-DOSA と A-DOSE の違い</h4>
        <ul>
          <li><strong>A-DOSA:</strong> 見えた進路を外へ示し、人を巻き込みながら前進させる。</li>
          <li><strong>A-DOSE:</strong> まず内側で確信を深め、必要な時に精度高く道を示す。</li>
        </ul>
        <p><strong>A-DOSA:</strong> 「私はこの道へ進ませたい。だから、はっきり示す。」</p>
        <p><strong>A-DOSE:</strong> 「私はこの道へ進ませたい。だから、軽々しくは示さない。」</p>
      `
    },
    "A-DIR": {
      title: "人情家（A-DIRA/E）",
      body: `
        <h3>人情家（A-DIRA/E）</h3>
        <p>人情家は、愛情を「個人への濃さ」として向ける人です。広く平均よりも、目の前の一人に深く反応します。</p>
        <p>本質は <strong>「深い愛情」×「個人への集中」×「情で動く力」</strong> にあります。</p>
        <h4>A-DIRA と A-DIRE の違い</h4>
        <ul>
          <li><strong>A-DIRA:</strong> 情が外へ出やすく、今ここで手を伸ばして動く。</li>
          <li><strong>A-DIRE:</strong> 情を内側に深く抱え、簡単には切り離さず持ち続ける。</li>
        </ul>
        <p><strong>A-DIRA:</strong> 「この人が大事だから、私は今ここで動く。」</p>
        <p><strong>A-DIRE:</strong> 「この人が大事だから、私は簡単には切り離せない。」</p>
      `
    },
    "A-DIS": {
      title: "教師（A-DISA/E）",
      body: `
        <h3>教師（A-DISA/E）</h3>
        <p>教師は、愛情を「理解と言葉」に変える人です。混乱や感情に輪郭を与え、相手が扱える形に整えます。</p>
        <p>本質は <strong>「深い愛情」×「理解したい意志」×「言葉と構造で支える力」</strong> にあります。</p>
        <h4>A-DISA と A-DISE の違い</h4>
        <ul>
          <li><strong>A-DISA:</strong> 分かったことを外へ返し、支えとして渡しやすい。</li>
          <li><strong>A-DISE:</strong> 内側で理解を熟成し、届く形になってから渡す。</li>
        </ul>
        <p><strong>A-DISA:</strong> 「分かったことを、今ここで支えとして渡したい。」</p>
        <p><strong>A-DISE:</strong> 「分かったことを、ちゃんと届く形にしてから渡したい。」</p>
      `
    },
    "A-SOR": {
      title: "守護者（A-SORA/E）",
      body: `
        <h3>守護者（A-SORA/E）</h3>
        <p>守護者は、愛情を「守る力」として表す人です。守りたいものを維持し、現実の中で継続できる形へ変えていきます。</p>
        <p>本質は <strong>「深い愛情」×「維持する責任感」×「守るために現実的に動く力」</strong> にあります。</p>
        <h4>A-SORA と A-SORE の違い</h4>
        <ul>
          <li><strong>A-SORA:</strong> 前に出て支え、守りを外へ見せやすい。</li>
          <li><strong>A-SORE:</strong> 静かに引き受け、見えないところで守り続ける。</li>
        </ul>
        <p><strong>A-SORA:</strong> 「守るために、私は前に出る。」</p>
        <p><strong>A-SORE:</strong> 「守るために、私は静かに持ち続ける。」</p>
      `
    },
    "A-SOS": {
      title: "指揮者（A-SOSA/E）",
      body: `
        <h3>指揮者（A-SOSA/E）</h3>
        <p>指揮者は、愛情を「全体の流れを整える力」に変える人です。個人だけでなく、場全体の温度や関係配置を見ます。</p>
        <p>本質は <strong>「深い愛情」×「全体を読む感性」×「流れを整えてまとめる力」</strong> にあります。</p>
        <h4>A-SOSA と A-SOSE の違い</h4>
        <ul>
          <li><strong>A-SOSA:</strong> 表で働きかけ、流れを動かす可視的な統率者。</li>
          <li><strong>A-SOSE:</strong> 内で見極め、必要な時だけ静かに整える調律者。</li>
        </ul>
        <p><strong>A-SOSA:</strong> 「全体をよくするために、私は今ここで流れを動かす。」</p>
        <p><strong>A-SOSE:</strong> 「全体を壊さないために、私はまず深く見てから動く。」</p>
      `
    },
    "A-SIR": {
      title: "探検家（A-SIRA/E）",
      body: `
        <h3>探検家（A-SIRA/E）</h3>
        <p>探検家は、愛情を「自分で確かめに行く力」に変える人です。考えるだけでなく、触れて動いて実感として掴みます。</p>
        <p>本質は <strong>「深い愛情」×「自分で確かめたい衝動」×「体験を通じて関係を作る力」</strong> にあります。</p>
        <h4>A-SIRA と A-SIRE の違い</h4>
        <ul>
          <li><strong>A-SIRA:</strong> 熱と行動が外へ出やすく、今すぐ飛び込む。</li>
          <li><strong>A-SIRE:</strong> 内側で熱を育て、切実さを持って踏み込む。</li>
        </ul>
        <p><strong>A-SIRA:</strong> 「気になった。だから私は今、確かめに行く。」</p>
        <p><strong>A-SIRE:</strong> 「ずっと気になっていた。だから私は自分で確かめる。」</p>
      `
    },
    "A-SIS": {
      title: "研究者（A-SISA/E）",
      body: `
        <h3>研究者（A-SISA/E）</h3>
        <p>研究者は、愛情を「深く掘り下げる力」に変える人です。軽い理解で終わらせず、時間をかけて本質へ近づきます。</p>
        <p>本質は <strong>「深い愛情」×「没入と探究」×「時間をかけて本質へ近づく力」</strong> にあります。</p>
        <h4>A-SISA と A-SISE の違い</h4>
        <ul>
          <li><strong>A-SISA:</strong> 深く見たものを外へ返し、相手に共有しやすい。</li>
          <li><strong>A-SISE:</strong> 深さを内で育て、軽々しく外へ出さない。</li>
        </ul>
        <p><strong>A-SISA:</strong> 「深く見たものを、ちゃんと相手へ返したい。」</p>
        <p><strong>A-SISE:</strong> 「深く見たものを、軽々しく外へ出したくない。」</p>
      `
    }
  };
  ...
  function renderTypeDetailsMenu() {
    ...
    keys.forEach((code) => {
      const baseDetail = groupData[code];
      const detail = currentTypeGroup === "A" && aGroupDetailedOverrides[code]
        ? aGroupDetailedOverrides[code]
        : baseDetail;
